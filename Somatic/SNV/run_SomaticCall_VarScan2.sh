...
do
	...
	echo $line | awk '{print "/home/qingtao/qingtao/panelTest/SomaticCall_VarScan2.sh "$1" "$2" "$3" "$4" "$5}'| awk '{ sub("\r$", ""); print }'  > Scripts/$sample.somatic.varscan2.sh
	sh Scripts/$sample.somatic.varscan2.sh
done
