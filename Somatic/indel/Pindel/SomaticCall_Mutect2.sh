...
#fi
start_time_mod=$(date +%s)
java -Xmx100g -Djava.io.tmpidir=tmpdir/${sample}_tmp -jar $gatk/GenomeAnalysisTK.jar -T MuTect2 -nct $nt -R $ref/hg19_nochr.fa -I:tumor $tumor_bam -I:normal $normal_bam --dbsnp $ref/dbsnp_132_b37.leftAligned.vcf --cosmic $ref/b37_cosmic_v54_120711.vcf -L $bed -o "Results"/$sample.mutect2.vcf
